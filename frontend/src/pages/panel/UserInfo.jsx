...
export default function UserInfo() {
  ...
  const CompleteProfileHandler = (e) => {
    ...
    fetch("http://127.0.0.1:8000/api/users/store", {
      ...
      .then(() => setMessage("پروفایل با موفقیت تکمیل شد ✅"))
          ...
          <div className="flex flex-col bg-white dark:bg-[#1B202C] py-6 px-10 gap-7 rounded-xl shadow-[0_3px_15px_5px_rgba(0,0,0,0.1)]">
            ...
            <form className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-5">
              {[
                ...
                { label: "تحصیلات", name: "education", type: "select", options: ["دیپلم","فوق دیپلم","لیسانس","فوق لیسانس","دکتری"] },
              ...
              <button
                ...
                className="w-[10rem] flex items-center justify-center gap-2 bg-green-600 hover:bg-green-500 cursor-pointer p-2 px-5 rounded-lg text-white text-[.9rem] mt-5 col-span-full"
              >
                تکمیل پروفایل
              </button>
            </form>
